package nl.nullPtr.toolMaterial;
...
public enum BambooToolMaterial implements ToolMaterial {
    ...
    DIAMOND(MiningLevels.DIAMOND, 400, 9.5f, 3.0f, 10, () -> Ingredient.ofItems(Items.DIAMOND)),
    NETHERITE(MiningLevels.NETHERITE, 900, 11.5f, 4.0f, 15, () -> Ingredient.ofItems(Items.NETHERITE_INGOT));
    ...
    BambooToolMaterial(int miningLevel, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
